...
func New(log *slog.Logger, auth *service.AuthService, handlers Handlers, requestIDPrefix string) *gin.Engine {
	gin.SetMode(gin.ReleaseMode)
	engine := gin.New()
	engine.Use(middleware.RequestID(requestIDPrefix), middleware.Recovery(log), middleware.ErrorHandler(log), cors())
